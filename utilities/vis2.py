...
def orthoslices2_3D(data, normalize=True, continuous_update=False, **kwargs):
    ...
    mdc_yproj_ax = fig.add_axes([.77, .5, .18, .4], xticklabels=[], yticklabels=[])
    mdc_yproj_ax.set_xlabel('$k_y$')
